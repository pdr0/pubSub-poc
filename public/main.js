...
var onMessage = function onMessage(msg, data) {
  return console.log("TOPIC: ".concat(msg, " - payload: ").concat(data));
};
...
loginButton.addEventListener('click', function (evt) {
  window.messages.publish(_topics["default"]["lotto.main.login.click"], true);
});
helpButton.addEventListener('click', function (evt) {
  window.messages.publish(_topics["default"]["lotto.main.help.click"], true);
});
searchButton.addEventListener('click', function (evt) {
  window.messages.publish(_topics["default"]["lotto.main.search.click"], true);
});
window.messages.publishSync(_topics["default"]['lotto.main.loaded'], true);
},{"../topics":2}],2:[function(require,module,exports){
"use strict";
